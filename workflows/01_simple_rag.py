...
Basic RAG pipeline (sliding window chunking + standard embeddings)

Usage:
    python workflows/01_simple_rag.py                    # First query
    python workflows/01_simple_rag.py --all              # All queries
    python workflows/01_simple_rag.py --query "Question"
    python workflows/01_simple_rag.py --max 5            # First 5 queries
"""
